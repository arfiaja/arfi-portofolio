...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="education.php">Education</a></li>
  ...
  <script>
        function DataDariAPIeducation() {
         axios.get('api/education_api.php')
          .then(response =>{
              //definisikan constanta data 
              const data = response.data[0];
              //manipulasi html untuk menampilkan data education
        ...
        <div class="row" data-aos="fade-up">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter=".filter-app">${data.smp}</li>
              <li data-filter=".filter-card">${data.sma}</li>
              <li data-filter=".filter-web">${data.unv}</li>
            </ul>
          </div>
        </div>
      </div>
