...
<body>
  ...
  <script>
        function DataDariAPIservices() {
         axios.get('api/services_api.php')
          .then(response =>{
              //definisikan constanta data 
              const data = response.data[0];
              //manipulasi html untuk menampilkan data services
